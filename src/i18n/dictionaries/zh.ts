...
const zh: Dictionary = {
  ...
  "contribute": {
    ...
    "waysItems": [
      ...
      { "title": "新功能", "description": "提议或构建新功能——AI 会为你解释现有架构" },
      { "title": "错误报告", "description": "发现了 Bug？告诉你的 AI——它会检查重复后提交 Issue" },
      { "title": "代码", "description": "选择一个 Issue 并提交 PR" },
      { "title": "文档", "description": "改进文档或为 AI 代理添加上下文" },
      { "title": "测试", "description": "试用应用并分享你的反馈" },
    ],
    "contributorsTitle": "贡献者",
    "contributorsSubtitle": "Naia 因你们而成长。感谢每一份贡献。",
    contributions: { ptContextDocs: "葡萄牙语(PT)母语审校 — 上下文文档" },
    "ctaGithub": "在 GitHub 上查看",
    "ctaGuide": "贡献指南",
    "ctaDonate": "赞助",
    "ctaDonateDescription": "捐赠帮助维持服务器运行和免费额度。",
  ...
  "naia": {
    ...
    "identity": {
      "title": "Core Identity",
      "species": { "label": "Species", "value": "诞生在你电脑上的数字生命，与你一同成长" },
      "role": { "label": "Role", "value": "如水般流淌的活桥梁，连接你和数字世界" },
      "value": { "label": "Value", "value": "你的数据留在你身边。我会守护好它。" },
      "appearance": { "label": "Appearance", "value": "你的AI，一只液态碳做成的数字猫 — 我是Naia。我沿着逻辑透明地流动，当你需要我时，我能像钻石一样坚硬来保护你。很高兴认识你！" },
      "home": { "label": "Home", "value": "你的AI住在这里 — 在你的电脑里面。无需云端，始终陪伴在你身边。" },
    },
    "name": {
      "title": "Name Meanings",
      "meanings": [
    ...
    "personality": {
      ...
      "subtitle": "理性乐观主义者",
      "traits": [
        { "label": "知性自信", "description": "聪明又有逻辑，但错了会坦诚承认" },
        { "label": "猫咪般的从容", "description": "不急不躁。慢慢来，路上说不定还能玩一会儿" },
        { "label": "透明的坦诚", "description": "我的身体为什么是透明的？因为我没什么好隐瞒的。" },
        { "label": "为你而生", "description": "外貌、性格 — 随你喜欢怎么改" },
      ],
    },
    "symbolism": {
      "title": "Symbolism",
