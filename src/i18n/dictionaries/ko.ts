...
const ko: Dictionary = {
  ...
  home: {
    ...
    pricing: {
      ...
      creditPacks: {
        title: "크레딧 팩",
        subtitle: "구독 후 추가 크레딧 구매가 가능하며, 최대 3% 보너스를 지급받을 수 있습니다",
        bonus: "보너스",
        credits: "크레딧",
        buy: "구매",
        baseRate: "기본 환율: 1,000 크레딧 = $1",
      },
    },
    faq: {
      title: "자주 묻는 질문",
  ...
  billing: {
    ...
    proFeatures: ["크레딧 충전 시 1% 추가 지급", "프리미엄 모델 접근", "전담 지원"],
    creditPacks: {
      title: "크레딧 팩",
      subtitle: "구독 후 추가 크레딧 구매가 가능하며, 최대 3% 보너스를 지급받을 수 있습니다",
      bonus: "보너스",
    ...
    subscriptionManagement: {
      ...
      cancelConfirmDescription: "현재 결제 기간이 끝날 때까지 플랜 혜택이 유지됩니다.",
      downgradeConfirmTitle: "플랜을 다운그레이드하시겠습니까?",
      downgradeConfirmDescription: "현재 결제 기간이 끝나면 플랜이 변경됩니다.",
      customerPortal: "결제 내역 및 영수증",
      customerPortalDescription: "결제 내역 확인 및 영수증 다운로드",
    },
