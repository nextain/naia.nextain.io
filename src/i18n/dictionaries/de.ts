...
const de: Dictionary = {
  ...
  "contribute": {
    "title": "Bei Naia mitwirken",
    "subtitle": "Naia ist AI-natives Open Source. Klone das Repo, lass dich von der KI leiten und trage in deiner Sprache bei.",
    "cloneTitle": "Klonen & KI fragen",
    "cloneDescription": "Keine Docs lesen, niemanden fragen. Dein KI-Coding-Tool liest den Projektkontext und leitet dich — in deiner Sprache.",
    "cloneAsk": "Frag in deiner Sprache: 'Was ist dieses Projekt und wie kann ich helfen?'",
    ...
    "waysItems": [
      ...
      { "title": "Fehlermeldungen", "description": "Etwas kaputt? Erstelle ein Issue in jeder Sprache" },
      { "title": "Code", "description": "Wähle ein Issue und sende einen PR" },
    ...
    "ctaDonate": "Sponsern",
    "ctaDonateDescription": "Naia wird von einem einzelnen Entwickler gebaut. Spenden halten die Server am Laufen und ermöglichen kostenlose Credits.",
