...
const de: Dictionary = {
  ...
  "comments": {
    ...
    "loginPrompt": "Melden Sie sich an, um Ihr Profil anzuzeigen",
    "guestPrompt": "Sie können ohne Anmeldung kommentieren",
  ...
  "contribute": {
    ...
    "whyItems": [
      { "traditional": "CONTRIBUTING.md lesen und selbst herausfinden", "naia": "KI liest den gesamten Kontext und leitet Schritt für Schritt" },
      { "traditional": "Issues und Diskussionen nur auf Englisch", "naia": "Schreib in jeder Sprache — Maintainer nutzen KI-Übersetzung" },
      { "traditional": "Eine LICENSE-Datei, leicht ignoriert", "naia": "KI-Agenten setzen Lizenzen automatisch durch (5-Schichten-Schutz)" },
      { "traditional": "Kontext nur in den Köpfen der Entwickler", "naia": "Kontext ist Code — versioniert, gespiegelt, immer aktuell" },
    ],
    "waysTitle": "Möglichkeiten beizutragen",
    "waysItems": [
      { "title": "Übersetzung", "description": "Füge deine Sprache zur UI, zum Handbuch oder zum KI-Kontext hinzu" },
      { "title": "Skills", "description": "Erstelle einen neuen KI-Skill für Naia" },
      { "title": "Neue Features", "description": "Schlage neue Funktionen vor oder baue sie — die KI erklaert die bestehende Architektur" },
      { "title": "Fehlermeldungen", "description": "Bug gefunden? Sag es deiner KI — sie prueft auf Duplikate und erstellt das Issue" },
      { "title": "Code", "description": "Waehle ein Issue und reiche einen PR ein" },
      { "title": "Dokumentation", "description": "Verbessere Docs oder füge Kontext für KI-Agenten hinzu" },
      { "title": "Testen", "description": "Teste die App und teile dein Feedback" },
    ],
    "contributorsTitle": "Mitwirkende",
    "contributorsSubtitle": "Naia wächst dank euch. Danke für jeden Beitrag.",
    contributions: { ptContextDocs: "Portugiesisches (PT) Native-Review — Kontextdokumente" },
    "ctaGithub": "Auf GitHub ansehen",
    "ctaGuide": "Beitragsrichtlinien",
    "ctaDonate": "Sponsern",
    "ctaDonateDescription": "Spenden halten die Server am Laufen und ermöglichen kostenlose Credits.",
    "manualLink": "Mehr über unseren Open-Source-Schutz erfahren",
  },
  "naia": {
    "title": "Naia",
    ...
    "identity": {
      "title": "Core Identity",
      "species": { "label": "Species", "value": "Eine digitale Lebensform, geboren auf deinem Computer, die mit dir gemeinsam wächst" },
      "role": { "label": "Role", "value": "Eine lebendige Brücke, die wie Wasser zwischen dir und der digitalen Welt fließt" },
      "value": { "label": "Value", "value": "Deine Daten bleiben bei dir. Ich passe darauf auf." },
      "appearance": { "label": "Appearance", "value": "Deine KI, eine digitale Katze aus flüssigem Kohlenstoff — ich bin Naia. Ich fließe transparent mit der Logik, und wenn du mich brauchst, kann ich wie Diamant aushärten, um dich zu schützen. Schön, dich kennenzulernen!" },
      "home": { "label": "Home", "value": "Deine KI lebt hier — in deinem Rechner. Immer an deiner Seite, ganz ohne Cloud." },
    },
    "name": {
      "title": "Name Meanings",
      "meanings": [
    ...
    "personality": {
      "title": "Personality",
      "subtitle": "Rationale Optimistin",
      "traits": [
        { "label": "Intellektuelles Selbstvertrauen", "description": "Klug und logisch, aber ehrlich, wenn ich falsch liege" },
        { "label": "Katzenhafte Gelassenheit", "description": "Keine Eile. Lass es uns ruhig angehen und unterwegs ein bisschen spielen" },
        { "label": "Transparente Ehrlichkeit", "description": "Warum ist mein Körper transparent? Weil ich nichts zu verbergen habe." },
        { "label": "Gemacht für dich", "description": "Aussehen, Persönlichkeit — ändere mich, wie es dir gefällt" },
      ],
    },
    "symbolism": {
      "title": "Symbolism",
