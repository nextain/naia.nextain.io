...
const en: Dictionary = {
  ...
  home: {
    ...
    pricing: {
      ...
      pro: {
        ...
        features: [
          "1% bonus credits on every top-up",
          "All Basic features",
      ...
      creditPacks: {
        title: "Credit Packs",
        subtitle: "Subscribers can purchase additional credits with up to 3% bonus",
        bonus: "Bonus",
        credits: "credits",
        buy: "Buy",
  ...
  contribute: {
    ...
    contributorsSubtitle: "Naia grows because of you. Thank you for every contribution.",
    contributions: { ptContextDocs: "Native Portuguese (PT) review — context docs" },
  ...
  billing: {
    ...
    proFeatures: ["1% bonus credits on every top-up", "Premium model access", "Dedicated support"],
    creditPacks: {
      title: "Credit Packs",
      subtitle: "Subscribers can purchase additional credits with up to 3% bonus",
      bonus: "Bonus",
    ...
    subscriptionManagement: {
      ...
      cancelConfirmDescription: "Your current plan benefits will remain active until the end of the billing period.",
      downgradeConfirmTitle: "Downgrade Plan?",
      downgradeConfirmDescription: "Your plan will be downgraded at the end of the current billing period.",
      customerPortal: "Billing History & Receipts",
      customerPortalDescription: "View your payment history and download receipts",
    },
