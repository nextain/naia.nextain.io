...
- **Read File**: Click a file from the list to view its contents in the text area.
- **Edit File**: You can edit the content within the text area and click **Save** to update the file immediately.

## Session Management
You can also manage the active conversation sessions for these agents.
- **Delete**: Remove unnecessary sessions.
- **Compact**: Summarize very long session histories to free up system memory.
